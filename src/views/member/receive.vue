            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd"
              ...
              <tr>
                ...
                <td colspan="3" align="left" bgcolor="#ffffff">
                  <div class="addr" @click="bubble(index)">
                    <v-distpicker class="address_value" :province="item.province" :city="item.city"
              ...
              <tr>
                ...
                <td align="left" bgcolor="#ffffff"><input name="mobile" type="text" class="inputBg" id="mobile_0"
                  ...
                  :class="{error:item.signer_mobile==''}">(必填)</span></td>
              </tr>
              <tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              ...
              <tr>
                ...
                <td align="left" bgcolor="#ffffff"><input name="mobile" type="text" class="inputBg" id="mobile_0"
                  ...
                  :class="{error:newInfo.signer_mobile==''}">(必填)</span></td>
              </tr>
              <tr>
                <td align="right" bgcolor="#ffffff">&nbsp;</td>
                <td colspan="3" align="center" bgcolor="#ffffff">
  ...
  methods: {
    ...
    confirmUpdate(id, index) { // 更新收货信息
      updateAddress(id, this.receiveInfoArr[index]).then((response) => {
        ...
        this.$notify({
          title: '更新结果',
          message: h('i', {style: 'color: teal'}, '更新收货信息成功')
        });
        this.getReceiveInfo();
      }).catch(function (error) {
        console.log(error);
